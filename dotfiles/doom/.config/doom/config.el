...
(after! clojure-mode
  ...
  (map! :map joker-mode-map
        ...
        ;; jet and neil ride in from Doom's clojure module, because
        ;; `joker-mode-map' inherits `clojure-mode-map'. jet converts
        ;; JSON/EDN/Transit and neil edits deps.edn — a joker script has
        ;; neither, so drop both rather than leave dead keys in the menu.
        "j" nil
        "f" nil
        (:prefix ("e" . "eval")
