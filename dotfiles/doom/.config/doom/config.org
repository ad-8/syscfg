...
- [[#dired][dired]]
- [[#fzf][fzf]]
- [[#ispell-aspell-hunspell][ispell aspell hunspell]]
- [[#janet][janet]]
- [[#calendar-setup-to-interact-with-radicale][Calendar setup to interact with radicale]]
  - [[#viewing-the-calendar-read-only-spc-j-c-c][viewing the calendar (read only): =SPC j c c=]]
