...
(def-doom-theme ax-hackerman
  ...
  ((evil-goggles-default-face :inherit 'region :background (doom-blend region bg 0.5))
   ...
   (org-level-1 :foreground green   :weight 'semi-bold)
   (org-level-2 :foreground cyan    :weight 'semi-bold)
   (org-level-3 :foreground teal    :weight 'semi-bold)
   ...
   ;; show-paren
   (show-paren-match :foreground green :background base0 :weight 'bold)
