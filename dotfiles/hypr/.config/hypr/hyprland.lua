...
-- TODO put into W or R submap? (w key i unused and well reachable)
...
hl.bind(mainMod .. "+ CTRL + M", hl.dsp.layout("colresize +0.05"))
hl.bind(mainMod .. "+ CTRL + N", hl.dsp.layout("colresize -0.05"))
