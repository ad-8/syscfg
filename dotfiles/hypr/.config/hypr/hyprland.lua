...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd(scripts .. "/waybar.clj launch &")
...
hl.bind(mod("SHIFT", "SSHARP"),   hl.dsp.exec_cmd(scripts .. "/bb/hypr-keybinds.clj"))
-- notifications
...
hl.window_rule({
  name        = "emacs-todo-scratchpad",
  match       = { class = "Emacs", title = "emacs-scratchpad-todo" },
