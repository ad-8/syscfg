...
hl.define_submap("open", function()
    ...
    hl.bind("C", function()
        hl.exec_cmd("qalculate-gtk")
        hl.dsp.submap("reset")
    end)
    hl.bind("E", function()
        hl.exec_cmd("emacsclient -c")
        hl.dsp.submap("reset")
    end)
    hl.bind("F", function()
    ...
    hl.bind("M", function()
        hl.exec_cmd("emacs --name ax-emacs-emms --eval '(ax/open-emms-layout)'")
        hl.dsp.submap("reset")
    end)
    ...
    hl.bind("W", function()
        hl.exec_cmd("foot -T wiremix wiremix")
        hl.dsp.submap("reset")
    end)
...
hl.define_submap("change", function()
    hl.bind("L", function()
        hl.exec_cmd("$HOME/syscfg/scripts/bb/licht.clj")
        hl.dsp.submap("reset")
    end)
    hl.bind("W", function()
...
hl.define_submap("toggle", function()
    hl.bind("B", function()
        hl.exec_cmd("rfkill toggle bluetooth")
        hl.dsp.submap("reset")
    end)
    hl.bind("W", function()
        hl.exec_cmd("rfkill toggle wifi")
        hl.dsp.submap("reset")
    end)
    hl.bind("escape", hl.dsp.submap("reset"))
end)
...
hl.define_submap("modeX", function()
    ...
    -- screenshot window
    hl.bind("W", function()
        hl.exec_cmd("$HOME/x/hypr-screenshot-window.sh")
        hl.dsp.submap("reset")
    end)
    hl.bind("escape", hl.dsp.submap("reset"))
end)
