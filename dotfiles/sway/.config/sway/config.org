...
#+begin_src shell
set $menu wmenu-run
set $menu2 i3-dmenu-desktop --dmenu='dmenu -i -fn "HackNerdFont 12" -nb "#0c1014" -nf "#99d1ce" -sb "#33859e" -sf "#000000"'
#+end_src
...
exec_always foot --app-id=dwm-scratchpad
...
exec_always foot --app-id=ax-org-capture emacs --no-window-system
# Show only that specific scratchpad terminal
